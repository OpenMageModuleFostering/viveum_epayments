...
class Netresearch_OPS_Model_Api_DirectLink extends Mage_Core_Model_Abstract
{
     ...
     */
      ...
      * @return array | null - null if requests were not successful, array containing Viveum payment data otherwise
      * 
      */
     protected function getResponseParams($params, $url, $retryCount = 0)
     {
         ...
         if ($retryCount < self::MAX_RETRY_COUNT) {
            try {
             ...
             Mage::throwException(Mage::helper('ops')->__('An error occured during the Viveum request. Your action could not be executed.'));
         }
         return $responseParams;
     }
