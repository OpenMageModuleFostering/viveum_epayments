...
class Netresearch_OPS_Model_Status_Update
{
    ...
    protected function updatePaymentStatus()
    {
        if (!array_key_exists('STATUS', $this->getOpsResponse())
            ...
            $this->getMessageContainer()->addNotice($this->getDataHelper()->__('No update available from Viveum.'));
           return $this;
        }
        ...
        $this->getMessageContainer()->addSuccess($this->getDataHelper()->__('Viveum status successfully updated'));
